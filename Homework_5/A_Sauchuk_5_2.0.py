...
def validate_name(name: str) -> str:
    """
    Функция validate_name выполняет проверку веденного пользователем имени.
...
def main():
    ...
    Удаляет возможный лишний пробел из имени.
    Вызывает функиции проверок validate_name, validate_age, validate_age_passport
    Если данные введены не корректно выводит ошибку и просит ввести данные заново

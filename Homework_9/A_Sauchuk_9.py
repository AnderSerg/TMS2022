...
class AudiCar(Car):
    ...
    @classmethod
    def create_red_ferrari(cls):
        red_ferrari = cls(label='ferrari', color='red')
        red_ferrari.info()
        print("Решено создать красную феррари на заводе Audi", cls.current_time())
        return red_ferrari

    @property
    def audi_max_speed(self):
        return self.max_speed

    @audi_max_speed.setter
    def audi_max_speed(self, value):
...
def main():
    ...
    print(VolksWagenCar.current_time())
    print(AudiCar.current_time())

    print()

    AudiCar.create_red_ferrari()

    print()

    AudiCar.audi_max_speed = 9999999
    print(AudiCar.audi_max_speed)
